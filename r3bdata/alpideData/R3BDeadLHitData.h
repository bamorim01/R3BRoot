...
class R3BDeadLHitData : public TObject
{
  public:
    // Default Constructor
    R3BDeadLHitData() = default;

    /** Standard Constructor
     *@param track    Reconstructed trajectory
     **/
    explicit R3BDeadLHitData(uint16_t sensorId,
    ...
    // Destructor
    virtual ~R3BDeadLHitData() = default;
  ...
  public:
    ClassDefOverride(R3BDeadLHitData, 1)
};
