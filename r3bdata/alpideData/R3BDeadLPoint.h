...
class R3BDeadLPoint : public FairMCPoint
{
  public:
    /** Default constructor **/
    R3BDeadLPoint();
  ...
  private:
    ...
    ClassDefOverride(R3BDeadLPoint, 2)
};

inline void R3BDeadLPoint::SetPositionOut(TVector3 pos)
{
    fX_out = pos.X();
    fY_out = pos.Y();
    fZ_out = pos.Z();
...
inline void R3BDeadLPoint::SetMomentumOut(TVector3 mom)
{
    fPx_out = mom.Px();
    fPy_out = mom.Py();
    fPz_out = mom.Pz();
