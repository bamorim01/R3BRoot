...
class R3BLosvsAlpideOnlineSpectra : public FairTask
{
  public:
    /**
     * Default constructor.
     ...
     */
    explicit R3BLosvsAlpideOnlineSpectra(const TString& name, int iVerbose = 1);

    /**
     * Destructor.
     * Frees the memory used by the object.
     */
    virtual ~R3BLosvsAlpideOnlineSpectra() = default;
  ...
  public:
    ClassDefOverride(R3BLosvsAlpideOnlineSpectra, 1); // NOLINT
};
