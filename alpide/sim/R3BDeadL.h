...
class R3BDeadL : public R3BDetector
{
  public:
    /** Default constructor **/
    R3BDeadL();
     ...
     *@param rot     rotation
     */
    R3BDeadL(const TString& geoFile, const TGeoTranslation& trans, const TGeoRotation& rot = TGeoRotation());

    /** Standard constructor.
     *@param geoFile name of the ROOT geometry file
     *@param combi   position + rotation
     */
    R3BDeadL(const TString& geoFile, const TGeoCombiTrans& combi = TGeoCombiTrans());
  ...
  private:
     ...
     **/
    R3BDeadLPoint* AddHit(Int_t trackID,
                           Int_t detID,
                           Int_t detCopyID,
                           TVector3 posIn,
                           TVector3 pos_out,
  ...
  public:
    ClassDefOverride(R3BDeadL, 2);
};

inline void R3BDeadL::ResetParameters()
{
