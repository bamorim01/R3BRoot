...
//#ifndef R3BTRACKINGWZ
//#define R3BTRACKINGWZ
#pragma once
...
class TH2F;
class R3BTrackingWZ : public FairTask
{
  public:
    R3BTrackingWZ();
    R3BTrackingWZ(const char* name, int iVerbose = 1);
    virtual ~R3BTrackingWZ();
...
//	    "TofdHit", "tttxHitData", "Mwpc0HitData", "Mwpc1HitData", "FrsData", "LosHit", NULL };
    //const char* fDetectorNames[DET_MAX + 1] = { "Fi30Hit", "Fi31Hit", "Fi32Hit", "Fi33Hit", "TofdHit", "Mwpc0HitData", "Mwpc1HitData", "FrsData", "LosHit", NULL };
    const char* fDetectorNames[DET_MAX + 1] = { "Fi30Hit", "Fi31Hit", "Fi32Hit", "Fi33Hit", "TofdHit", "Mwpc0HitData", "Mwpc1HitData", "LosHit", NULL };
    ...
    bool fi31_only = false;
    bool fi33_only = false;
    bool bothfi = false;
    bool fi31_track = false;
    bool fi33_track = false;
    double fi31_counts=0;
    double fi33_counts=0;
    double bothfi_counts=0;
    ...
    /* ----- tracker Histograms ----- */
    TH2F* AoQ_Vs_Q_TOFD;
    TH2F* AoQ_Vs_Q_TOFD_fi31;
    TH2F* AoQ_Vs_Q_TOFD_fi33;
    TH2F* AoQ_Vs_Q_TOFD_bothfi;
    TH2F* AoQ_Vs_Q_TTTX;
    TH1F* Track_mult_fi31;
    TH1F* Track_mult_fi33;
    TH1F* Track_mult_bothfi;
