...
const double Exe       = 0.;        // Residual excitation energy (MeV) (change it for deeply bound states)
const bool   ISOTROPIC = true;           // Internal momentum spread (Gauss)
//const double UNIT = 931.494061;          // Atomic mass unit MeV/c
const double UNIT = 931.494028;//931.4940954;          // Atomic mass unit MeV/c
...
const double MA  = 12.*UNIT; //12.*UNIT;		          // Nuclear mass of initital A nucleus(MeV/c
const double MB  = 11.009305404*UNIT + Exe;//10.012936862*UNIT - 5*5.48579909070*UNIT*0.0001 + Exe;  //11.009305404*UNIT + Exe;       // Nuclear mass of the residual fragment B (MeV/c
const double MOM_SIGMA = 100.00;//130.00;                  // Internal momentum spread (Gauss)
